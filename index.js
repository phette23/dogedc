const fs = require('fs') // used to get dewey.json data
...
DDC.prototype.getRandomClassNum = function () {
    ...
    var rando = function () { return Math.floor(Math.random() * 1000).toString() }
        , classNum = rando().padStart(3, '0')
